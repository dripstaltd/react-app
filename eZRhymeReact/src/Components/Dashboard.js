  ...
  return (
    <div className="flex flex-col flex-wrap overflow-hidden content-around items-center p-3">
      ...
      <Paper className="w-full overflow-hidden p-4 m-1 m-3">
        ...
        <div className="text-indigo-400 font-sans text-left p-3 m-3 text-3xl font-bold">
      ...
      <div className="w-full flex flex-wrap m-3 overflow-hidden">
        <button className="flex border-2 border-white w-1/2 overflow-hidden sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2  p-2 bg-blue-600 rounded text-white justify-center font-sans text-center  self-center">
          <FontAwesomeIcon
